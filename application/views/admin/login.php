				...
				<div class="graphs">
					<div class="sign-in-form">
						<div class="sign-in-form-top">
							<p><span>Sign In to</span> <a href="<?php echo base_url();?>register">Admin</a></p>
						</div>
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
								   ...
								   <input type="password" class="lock" name="user_password" value="<?php echo set_value('user_password');?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
